...
const LOGO_URLS = {
  ...
  microsoft: '/contenido/Microsoft_logo.png',
  sandvik: '/contenido/sandvik_logo.png',
  bureauveritas: '/contenido/bureau_veritas_logo.png',
  ...
  windchill: '/contenido/Windchill_logo.png',
  navantia: '/contenido/Navantia_logo.png',
  texasControls: '/contenido/texas_logo.png',
  britishCouncil: '/contenido/British_Council_logo.png',
  foran: '/contenido/Navantia_logo.png',
  ...
  access: '/logos/access.svg',
  vibecode: '/logos/codex.svg',
};
...
const HERO_DATA: Record<Language, HeroData> = {
  es: {
    ...
    image: 'contenido/mario.png',
    cvUrl: 'contenido/CV_Mario_Fernandez.pdf',
  ...
  es: [
    {
      ...
      visualType: 'image',
      visualContent: '/contenido/pistola.png',
    ...
    },
    {
      ...
      visualContent: '/contenido/nave.png',
    ...
    },
    {
      ...
      visualType: 'model',
      visualContent: '/contenido/F1.STL',
